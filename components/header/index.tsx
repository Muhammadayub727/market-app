              ...
              <div className="flex items-center">
                ...
                <ul className="flex items-center gap-[30px]">
                  {data.map((item, index) => {
                    return (
                      <li key={index}>
                        <Link href={item.path} className={pathname === item.path ? "text-[#FBD029]" : "text-white"}>
                          {item.title}
                        </Link>
                      </li>
                    );
        ...
        <div className="container mx-auto px-[10px]">
          <div className="py-[15px] flex items-center justify-between">
            ...
            <div className="flex items-center gap-[15px]">
              ...
              <button onClick={handleClick} className={pathname === "/cart" ? "flex items-center gap-[10px] px-[30px] py-[14px] rounded-[5px] bg-[#FBD029] text-black" : "flex items-center gap-[10px] px-[30px] py-[14px] rounded-[5px] bg-[#F2F2F2] text-black hover:bg-[#FBD029] active:bg-[#F2F2F2] duration-300"}>
